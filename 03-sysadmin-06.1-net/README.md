...
> Ответ:
Перввый ответ от HTTP сервера имеет Status Code 200.
Дольше всего обрабатывался запрос "check_unread_tickets" - 83 ms.

![Browser-Network](https://github.com/lenazve1996/imagesforreadme/blob/main/Browser-Network.png)
